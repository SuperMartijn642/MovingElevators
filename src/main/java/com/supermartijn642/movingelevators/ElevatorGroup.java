...
public class ElevatorGroup {
    ...
    private void syncMovement(){
        if(!this.world.isRemote)
            MovingElevators.CHANNEL.send(PacketDistributor.DIMENSION.with(this.world.getDimension()::getType), new ElevatorMovementPacket(this.x, this.z, this.facing, this.currentY));
    }
