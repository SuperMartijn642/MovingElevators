...
public class MovingElevators {
    ...
    public static class RegistryEvents {
        ...
        public static void onBlockRegistry(final RegistryEvent.Register<Block> e){
            Block.Properties properties = Block.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).strength(1.5F, 6.0F);
