...
public class ElevatorScreen extends TileEntityBaseScreen<ControllerBlockEntity> {
    ...
    @Override
    protected void render(PoseStack matrixStack, int mouseX, int mouseY, @Nonnull ControllerBlockEntity blockEntity){
        // Background
    ...
    @Override
    protected void renderTooltips(PoseStack matrixStack, int mouseX, int mouseY, @Nonnull ControllerBlockEntity blockEntity){
