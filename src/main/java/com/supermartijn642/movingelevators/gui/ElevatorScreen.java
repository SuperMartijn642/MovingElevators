...
public class ElevatorScreen extends BlockEntityBaseWidget<ControllerBlockEntity> {
    ...
    @Override
    protected void renderBackground(PoseStack poseStack, int mouseX, int mouseY, ControllerBlockEntity object){
        // Background
    ...
    @Override
    protected void render(PoseStack poseStack, int mouseX, int mouseY, ControllerBlockEntity blockEntity){
        // Size icons
    ...
    @Override
    protected void renderTooltips(PoseStack poseStack, int mouseX, int mouseY, @NotNull ControllerBlockEntity blockEntity){
