 ...
 */
public class ElevatorSpeedSlider extends GuiButton {
    ...
    public ElevatorSpeedSlider(int xIn, int yIn, int widthIn, int heightIn, double currentValue, Consumer<ElevatorSpeedSlider> onChange){
        ...
        this.sliderValue = normalize((float)currentValue);
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            if (this.dragging)
            {
                ...
                this.sliderValue = normalize(denormalize(this.sliderValue));
                this.updateMessage();
